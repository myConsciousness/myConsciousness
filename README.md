...
> Shinya Kato 🤯 @shinyakato.dev 2023-08-19T15:01:26.301Z
>
> なると思いますね。あとfacet以外であっても基本的にはLexiconに定義された通りの入出力で実装しますが、ポストみたいなRecordはLexiconの定義をオーバーライドしない限りはどんなデータでも登録できますし、実際に取得もできてしまいます。例えば、”via”フィールドであったり位置情報を表す”place”のようなLexiconで定義されていないフィールドですね。フィールドの名前は任意です。

なので特定のサードパーティクライアント特有の仕様を簡単に作れますし、開発者同士で認識を合わせて新しい機能を作ることも可能です

---

> Shinya Kato 🤯 @shinyakato.dev 2023-08-19T14:35:07.697Z
>
> 一度サインアウトしてからサインイン画面に行くと「Forgot」の選択肢があるのでそこからいけます
