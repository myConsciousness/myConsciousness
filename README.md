...
> Shinya Kato 🤯 @shinyakato.dev 2023-08-15T14:41:53.476Z
>
> 起動させられました

---

> Shinya Kato 🤯 @shinyakato.dev 2023-08-15T14:19:07.928Z
>
> 公式のモデレーション用のラベルを自分で付ければできますね
...
>
> Here is the released list of union types

https://github.com/myConsciousness/atproto.dart/blob/main/packages/bluesky/CHANGELOG.md#v081

---

> Shinya Kato 🤯 @shinyakato.dev 2023-08-15T09:53:13.029Z
>
> I have released the latest builds of `atproto` and `bluesky` for Dart/Flutter :) This release allows the use of Dart3 pattern matching for Union objects generated by freezed. Object names that can be used in pattern matching are always prefixed with `U` for Union, like `USubscribedRepoCommit`
