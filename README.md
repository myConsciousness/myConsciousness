...
> Shinya Kato 🤯 @shinyakato.dev 2023-08-19T14:24:42.441Z
>
> UI上の表現はクライアントの実装次第ですね。仮にハッシュタグがfacetとして実装されるとすると、”$type”は”hashtag”みたいに定義されて単純なリンクとは明確に区別されるので、あとはクライアント側の仕事になります。

RichTextを採用した理由までは知りませんが、RichTextはマークダウンのようにリンクを作れたり太字にできたりとテキストの表現力が非常に高いのが特徴ですね。逆に言うと、クライアント開発者の実装力が非常に試される仕様です
